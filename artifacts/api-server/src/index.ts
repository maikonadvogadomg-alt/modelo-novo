...
wss.on("connection", (ws: WebSocket) => {
  ...
  // ── Keepalive: evita que o proxy de producao feche conexoes ociosas ──────
  // Envia um ping a cada 20s; se o cliente nao responder em 10s, encerra.
  let isAlive = true;
  ...
  // Mensagem de boas-vindas com info do workspace (após 500ms para o shell iniciar)
  setTimeout(() => {
    if (shell.stdin && !shell.killed) {
      shell.stdin.write(`echo -e "\\x1b[90m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\\r\\n📁 Workspace: ${cwd}\\r\\n💡 'node arquivo.js' ou 'python3 arquivo.py' — use Sync↑ no editor primeiro!\\r\\n━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\\x1b[0m"\r\n`);
    }
  }, 600);
